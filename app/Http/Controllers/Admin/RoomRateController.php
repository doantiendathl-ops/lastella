    ...
    public function index(IndexRequest $request): Response
    {
        ...
        return Inertia::render('Admin/CrudIndex', [
            ...
            'columns' => [
                ...
                ['key' => 'valid_from', 'label' => 'Hiệu lực từ', 'sortable' => true, 'type' => 'date'],
                ['key' => 'valid_to', 'label' => 'Hiệu lực đến', 'sortable' => true, 'type' => 'date'],
                ['key' => 'overnight_price', 'label' => 'Qua đêm', 'sortable' => true, 'type' => 'money'],
                ['key' => 'hourly_price', 'label' => 'Theo giờ', 'type' => 'money'],
    ...
    private function formProps(string $title, string $action, string $method, array $values = []): array
    {
        return [
            ...
            'fields' => [
                ...
                ['name' => 'overnight_price', 'label' => 'Giá qua đêm', 'type' => 'money', 'required' => true],
                ['name' => 'hourly_price', 'label' => 'Giá theo giờ', 'type' => 'money', 'required' => true],
                ['name' => 'extra_adult_price', 'label' => 'Người lớn thêm', 'type' => 'money', 'required' => true],
                ['name' => 'extra_child_price', 'label' => 'Trẻ em thêm', 'type' => 'money', 'required' => true],
                ['name' => 'early_checkin_price', 'label' => 'Nhận phòng sớm', 'type' => 'money', 'required' => true],
                ['name' => 'late_checkout_price', 'label' => 'Trả phòng muộn', 'type' => 'money', 'required' => true],
